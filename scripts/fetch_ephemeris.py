...
Uses SPICE kernels as the sole authoritative source.
...
def main() -> None:
    parser = argparse.ArgumentParser(description="Fetch Artemis 2 ephemeris data from SPICE")
    ...
    print("  SPICE required — no fallback path")
    try:
        ...
        print(f"  ✗ SPICE ephemeris generation failed: {e}")
        sys.exit(1)
    ...
    output = {
        ...
        "moonOrientationModel": "SPICE J2000->IAU_MOON transform from loaded kernels",
        **data,
    }
